public class DialogueMass
{
    public static string[] Rus =
    {
            "LexusLight", //0
            "Игра сохранена.", //1
            "Атакуйте врага, как только появится его индикатор.",//2
            ...
            "Удачи!",//20
            "Вы можете иметь только одно заклинание одного типа.",//21
            ...
            "Вставай! \nЯ объясню как всё устроено.",//60
            "Да начнётся гениальный туториал!",//61
            "~Фиат Люкс!",//62
            "Чё как?",//63
            "Давай на перегонки: Кто первый до моста?",//64
            "Только чур не жульничать!",//65
            "Кот ретировался с помощью телепортации.",//66
            "Кажется, вы не согласны играть в эти игры.",//67
            "Если долго вглядываться в это дерево, то оно начинает вглядываться в тебя.",//68
            "Вам не по-себе.",//69
            "На табличке начертаны странные надписи. Поверх них написана какая-то лирика. ",//70
            "'Звёзды упали. \nНадежды пропали.'",//71
            "'Часы прозвенели. \nЛеса опустели.'",//72
            "'Мир защитить. \nСобой заслонить.'",//73
            "'Должна победить! \nИ меня не убить!'",//74
            "'Пожалуйста, не включайте кнопку!'",//75
            "'Пожалуйста, включайте кнопку!'",//76
            "'Розы ведут к истине.'",//77
            "Что-то громко щёлкнуло.",//78
            "Деревья словно раздвинулись между роз.",//79
            "Первый зверь НЕ ЖЁЛТЫЙ, \nвторой зверь НЕ ЗЕЛЁНЫЙ.",//80 ГОЛОВОЛОМКА
            "Первый зверь НЕ КРАСНЫЙ, \nтретий зверь НЕ ЗЕЛЁНЫЙ",//81
            "Хэй, дружок-пирожок! \nТобою выбран неправильный лес.",//82
            "Людям тут ходить весьма опасно. \nХотя постой-ка....",//83
            "Не может быть!\nТак ты даже не человек... \nЧто это?!!!!!",//84
            "Что ты такое? Эта магия! Сильная магия! \nЕё так много! \nИ всё почти задаром...",//85
            "Кстати, меня зовут Кинг.",//86
            "И ты уже обречён).",//87
            "Я сдаюсь.",//88
            "Ай....",//89
            "Бдыщ!",//90
            "Ой!",//91
            "Стой! Извини меня! \nЯ не хочу умирать.",//92
            "...",//93
            "~ Вы сделали вид, что отвернулись. \nКинг сбежал. \nВы избежали лишней смерти.",//94
            "~ Кинг пал в неравной схватке с вами. \nВас ведёт жажда мести.",//95
            ...
            "~ Ты - вершитель правосудия. \nИ ты можешь прощать.",//103
            "~ Но существуют поступки, которые очень глупо оставлять просто так.",//104
            ".................",//105
            "Звёзды.....",//106
            "Ты знаешь, что звездоцветы растут в местах магии?.....",//107
            "Они распускаются ровно в ночь, \nпоглощая лунный свет.......",//108
            "Розы...... \nПрекрасные розы......",//109
            "Они - знаки судьбы. \nРозы распускаются ровно там, где вершится чьё-то предназначение.",//110
            "Я вижу как они ведут тебя к выходу. \nК выходу во внешний мир.",//111
            "Ведут ли они тебя на верную гибель от моей руки?......\nНе знаю.",//112
            "Но эта магия.... Магия ИНЫХ. Ты буквально состоишь из неё.",//113
            "Таким как ты нет места в этом мире.",//114
            "Своим присутствием ты уже наносишь этому месту ужасный вред. \nЯ видела твою жестокость.",//115 
            "Те живые растения - всего лишь порождения магии. \nНо что, если ты вырвешься во внешний мир?",//116
            "Развернись, иначе тебя ждёт гибель.",//117
            "Однако, ты избегаешь насилия. \nПытаешься сбежать?.....",//118
            "Заслуживаешь-ли ты милосердия?....",//119
            "Очень скоро мы это узнаем.",//120
            ...
            "Иная магия.",//143
            "Самая непредсказуемая и мощная магия. Источники магии - ИНОЙ МИР. Абстрактное пространство вне нашего понимания.",//144
    ...
    public static string[] Eng =
{
            ...
            "~Fiat Lux!",//62
            "What's up?",//63
            "How about a race to the bridge?",//64
            "But no cheating allowed!",//65
            "Cat phased away with the powers of teleportation.",//66
            ...
            "'I should fight. \nWith all my might...'",//74
            "'Please do not turn on the button!'",//75
            "'Please turn on the button!'",//76
            "Roses lead to the truth.",//77
            "Something clicked loudly.",//78
            "The trees seemed to be parted between roses.",//79
            "The first beast is NOT YELLOW, \nthe second beast is NOT GREEN.", // 80 PUZZLE
            "The first beast is NOT RED, \nthe third beast is NOT GREEN", // 81
            "Hey buddy! \n I think you got the wrong forest.",//82
            "It's pretty dangerous for humans to wander here. \n But wait a bit....",//83
            "It can't be!\n You aren't even human...",//84
            ...
            "Bush!",//90
            "Ha~",//91
            "Wait! I'm sorry! \nI don’t want to die.", // 92
            "...", // 93 
            "~ King escaped. You did not kill him. \nYou escaped unnecessary death.", // 94
            ...
            ".................",//105
            "Stars.....",//106
            "Did you know that starbloom only grows in places with magic?.....",//107
            "They bloom exactly at midnight,\n absorbing moonlight.....",//108
            "Roses......\nBeautiful roses.......",//109
            ...
            "The living plants are just creatures made with magic. \nBut what if you break into the outer world?",//116
            "Turn back, or else your fate will be due",//117
