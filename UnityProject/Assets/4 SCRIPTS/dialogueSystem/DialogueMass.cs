...
public class DialogueMass
{
    public static string[] Rus =
    {
            ...
            "Меня зовут Беатрис. Я была одной из безупречных солдат империи Сансис.",//158
    ...
    public static string[] Eng =
{
            ...
            "Меня невозможно убить!",//172
            "Да... Кажется ты в разы сильнее меня....",//173
            "Ничего не понимаю. Но раз судьба выбрала ТЕБЯ...",//174
            "Then..... It has to be this way....",//175
            "Per aspera ad astra!",//176
            "Ч-ч-что?    \nТЫ?",//177
    };
}
